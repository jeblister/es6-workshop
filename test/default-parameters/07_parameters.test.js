...
describe('default parameters make function parameters more flexible', () => {
  ...
  it.skip('define it using an assignment to the parameter `function(param=1){}`', function() {
    let number = (int) => int;

    assert.equal(number(), 0);
  });

  it.skip('it is used when undefined is passed', function() {
  ...
  it.skip('it is not used when a value is given', function() {
    function xhr() {
      return method;
    }
  ...
  it.skip('it is evaluated at run time', function() {
    let defaultValue;
  ...
  it.skip('it can also be a function', function() {
    let defaultValue;
