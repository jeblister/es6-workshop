...
describe('ES6 Modules: use `import` to import functions that have been exported (somewhere else)', () => {
  it.skip('import an entire module using `import <name> from "<moduleName> or path"`', () => {
  ...
  it.skip('Can alias the import name : using `{member as alias}` as memberName', () => {
  ...
  it.skip('can destructure the import, to only retain pieces of the import using `import {<memberName>} from "module"` you will separate multiple members with a comma', () => {
