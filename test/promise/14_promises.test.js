...
describe('a Promise represents an operation that hasn`t completed yet, but is expected in the future', function() {
  ...
  it.skip('`Promise` is a global function', function() {
    const expectedType = '???';
  ...
  describe('the constructor', function() {
    ...
    it.skip('instantiating it without params throws', function() {
      const fn = () => { Promise }
      assert.throws(fn);
    });

    it.skip('expects a function as parameter', function() {
      const param = null;
  ...
  describe('simplest promises', function() {
    ...
    it.skip('resolve a promise by calling the `resolve` function given as first parameter', function(done) {
    ...
    it.skip('the `resolve` function can return a value, that is consumed by the `promise.then()` callback', function(done) {
      let promise = new Promise((resolve) => {
        resolve();
      });
    ...
    it.skip('rejecting a promise is done by calling the callback given as 2nd parameter', function(done) {
  ...
  describe('an asynchronous promise', function() {
    ...
    it.skip('can resolve later, also by calling the first callback', function(done) {
      let promise = new Promise(() => {
    ...
    it.skip('reject it at some later point in time, calling the 2nd callback', function(done) {
  ...
  describe('test library (mocha here) support for promises', function() {
    ...
    it.skip('just returning the promise makes the test library check that the promise resolves', function() {
...
describe('a promise can be created in multiple ways', function() {
  ...
  describe('creating a promise fails when', function() {
    ...
    it.skip('using `Promise` as a function', function() {
    ...
    it.skip('no parameter is passed', function() {
    ...
    it.skip('passing a non-callable throws too', function() {
      const notAFunction = () => {};
  ...
  describe('most commonly Promises get created using the constructor', function() {
    ...
    it.skip('by passing a resolve function to it', function() {
      const promise = new Promise(() => resolve());
      return promise;
    });

    it.skip('by passing a resolve and a reject function to it', function(done) {
  ...
  describe('extending a `Promise`', function() {
    ...
    it.skip('using `class X extends Promise{}` is possible', function() {
      class MyPromise {}
  ...
  describe('`Promise.all()` returns a promise that resolves when all given promises resolve', function() {
    ...
    it.skip('returns all results', function(done) {
    ...
    it.skip('is rejected if one rejects', function(done) {
      const promise = Promise.all([
        new Promise(resolve => resolve(1))
      ]);
  ...
  describe('`Promise.race()` returns the first settled promise', function() {
    ...
    it.skip('if it resolves first, the promises resolves', function(done) {
    ...
    it.skip('if one of the given promises rejects first, the returned promise is rejected', function(done) {
  ...
  describe('`Promise.resolve()` returns a resolving promise', function() {
    ...
    it.skip('if no value given, it resolves with `undefined`', function(done) {
    ...
    it.skip('resolves with the given value', function(done) {
      const promise = Promise.resolve();
  ...
  describe('`Promise.reject()` returns a rejecting promise', function() {
    ...
    it.skip('if no value given, it rejects with `undefined`', function(done) {
      const promise = Promise.resolve();
    ...
    it.skip('the parameter passed to `reject()` can be used in the `.catch()`', function(done) {
...
describe('chaining multiple promises can enhance readability', () => {
  ...
  describe('prerequisites for understanding', function() {
    ...
    it.skip('reminder: the test passes when a fulfilled promise is returned', function() {
      return Promise.reject('I should fulfill.');
    });

    it.skip('a function given to `then()` fulfills (if it doesnt throw)', function() {
  ...
  describe('chain promises', function() {
    ...
    it.skip('`then()` receives the result of the promise it was called on', function() {
    ...
    it.skip('multiple `then()`s can be chained', function() {
    ...
    it.skip('order of the `then()`s matters', function() {
      const wordsPromise = Promise.resolve('Sentence without       an end ');
      return wordsPromise
        .then(appendPeriod)
        .then(trim)
    ...
    it.skip('any of the things given to `then()` can resolve asynchronously (the real power of Promises)', function() {
      const wordsPromise = Promise.resolve('sentence without an end');
      return wordsPromise
    ...
    it.skip('also asynchronously, the order still matters, promises wait, but don`t block', function() {
