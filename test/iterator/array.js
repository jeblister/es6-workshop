...
describe('array is a built-in iterable object', function() {
  ...
  describe('the iterator', function() {
    it.skip('an array has an iterator, which is a function', function() {
  ...
  describe('the iterator protocol', function() {
    ...
    it.skip('calling `next()` on an iterator returns an object according to the iterator protocol', function() {
      const iterator = arr[Symbol.iterator]();
    ...
    it.skip('the after-last element has done=true', function() {
      const arr = [];
      const iterator = arr[Symbol.iterator]();
